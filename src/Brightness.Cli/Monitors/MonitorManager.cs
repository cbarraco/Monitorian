...
public class MonitorManager
{
	...
	{
		var ids = Environment.GetCommandLineArgs()
			.Skip(1)
	...
	[DataContract]
	private class DisplayItemPlus(DeviceContext.HandleItem handleItem)
	{
		[DataMember]
		public int DisplayIndex { get; private set; } = handleItem.DisplayIndex;

		[DataMember]
		public DisplayInformationProvider.DisplayItem DisplayItem { get; } = new DisplayInformationProvider.DisplayItem(handleItem.MonitorHandle);
	}
