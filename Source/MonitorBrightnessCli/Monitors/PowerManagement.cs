...
internal class PowerManagement
{
	...
	{
		return HasOption(PowerBindOption);
	});
	...
	{
		return HasOption(PowerIgnoreOption);
	});

	private static bool HasOption(string option) =>
